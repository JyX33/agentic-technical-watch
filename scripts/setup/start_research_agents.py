...
class AgentManager:
        ...
        self.agent_configs = [
            {
                "name": "RetrievalAgent",
                "port": 8001,
                "script": "scripts/runners/run_retrieval_agent.py",
            },
            {
                "name": "FilterAgent",
                "port": 8002,
                "script": "scripts/runners/run_filter_agent.py",
            },
            {
                "name": "SummariseAgent",
                "port": 8003,
                "script": "scripts/runners/run_summarise_agent.py",
            },
            {
                "name": "AlertAgent",
                "port": 8004,
                "script": "scripts/runners/run_alert_agent.py",
            },
        ]
    ...
    def start_agents(self):
        ...
        if self.processes:
            ...
            print("   Test with: uv run python tests/integration/test_real_workflow.py")
            print(
                "   Manual test: uv run python scripts/demos/manual_reddit_research.py"
            )
